...
Build Python data pipelines for cleaning, deduplication, and cross-source reconciliation. Write and validate SQL metric logic across operational datasets. Evaluate LLM outputs and compare prompt and model configurations.
